...
namespace KetitoAPI.Helpers
{
	public class clsSession
	{
		...
		//public bool validaMenu(int idMenu)
		//{

		//    string conex = SqlServer.generaConexion("csSCC");
		//    string sqlQuery = "SELECT [IdMenu] FROM [SCC].[dbo].[PerfilMenu] WHERE [IdPerfil]=" + this.get("idPerfil").ToString() + " AND [IdMenu]=" + idMenu;

		//    return (SqlServer.ExistReg(conex, sqlQuery));
